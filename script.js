...
map.on('load', () => {
  ...
  fetch('assets/Cleaned_Transit_Stops.geojson')
    ...
    // Add light rail markers
    const lightRailMarkers = []; // Store markers for toggling
    let lightRailVisible = true; // Initial visibility state
    
    const lightRailStations = [
      { lng: -122.29661, lat: 47.81789, title: "Lynwood City Center Station" },
      { lng: -122.31465, lat: 47.78573, title: "Mountlake Terrace Station" },
      { lng: -122.32001, lat: 47.76499, title: "Shorline North Station" },
      { lng: -122.32104, lat: 47.73671, title: "Shorline South Station" },
      { lng: -122.32860, lat: 47.70361, title: "Northgate Station" },
      { lng: -122.31602, lat: 47.67669, title: "Roosevelt Station" },
      { lng: -122.31408, lat: 47.66012, title: "U District Station" },
      { lng: -122.30374, lat: 47.65043, title: "University of Washington Station" },
      { lng: -122.32063, lat: 47.61993, title: "Capitol Hill Station" },
      { lng: -122.33753, lat: 47.61161, title: "Westlake Station" },
      { lng: -122.33604, lat: 47.60796, title: "Symphony Station" },
      { lng: -122.33115, lat: 47.60220, title: "Pioneer Square Station" },
      { lng: -122.32802, lat: 47.59851, title: "International District Station" },
      { lng: -122.32714, lat: 47.59106, title: "Stadium Station" },
      { lng: -122.32737, lat: 47.58130, title: "Sodo Station" },
      { lng: -122.31182, lat: 47.57935, title: "Beacon Hill Station" },
      { lng: -122.29769, lat: 47.57666, title: "Mount Baker Station" },
      { lng: -122.29263, lat: 47.56007, title: "Colombia City Station" },
      { lng: -122.28153, lat: 47.53824, title: "Othello Station" },
      { lng: -122.27942, lat: 47.52266, title: "Rainier Beach Station" },
      { lng: -122.28829, lat: 47.46430, title: "Tukwila International Blvd Station" },
      { lng: -122.29698, lat: 47.44565, title: "Seatac Airport Station" },
      { lng: -122.29780, lat: 47.42253, title: "Angle Lake Station" },
    ];
    ...
    lightRailStations.forEach(({ lng, lat, title }) => {
      ...
      const marker = new mapboxgl.Marker(el)
        .setLngLat([lng, lat])
        .setPopup(new mapboxgl.Popup().setHTML(`<strong>${title}</strong>`)) // Popup on click
        .addTo(map);

      lightRailMarkers.push(marker); // Store for toggling
    });

    // Toggle Light Rail visibility
    const toggleLightRailButton = document.getElementById('toggleLightRail');
    toggleLightRailButton.addEventListener('click', () => {
